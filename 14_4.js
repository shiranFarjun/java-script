...
console.log(food(data));
    ...
    //1)TypeError: foodObj.forEach is not a function
    //2)break point
    //3) forEach showed undefined in the debugger because it's object and not array.
    //4)added specifcation to foodObj.meats to solve